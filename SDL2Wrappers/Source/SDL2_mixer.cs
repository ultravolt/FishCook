...
namespace SDL2
{
    public static class SDL_mixer
    {
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_Quit", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_QuerySpec", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* IntPtr refers to a Mix_Chunk* */
        [DllImport(nativeLibName, EntryPoint = "Mix_QuickLoad_WAV", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* IntPtr refers to a Mix_Chunk* */
        [DllImport(nativeLibName, EntryPoint = "Mix_QuickLoad_RAW", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_FreeChunk", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_FreeChunk(IntPtr chunk);

        /* music refers to a Mix_Music* */
        [DllImport(nativeLibName, EntryPoint = "Mix_FreeMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_FreeMusic(IntPtr music);

        [DllImport(nativeLibName, EntryPoint = "Mix_GetNumChunkDecoders", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_GetNumMusicDecoders", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* music refers to a Mix_Music* */
        [DllImport(nativeLibName, EntryPoint = "Mix_GetMusicType", CallingConvention = CallingConvention.Cdecl)]
        public static extern Mix_MusicType Mix_GetMusicType(IntPtr music);

        [DllImport(nativeLibName, EntryPoint = "Mix_SetPostMix", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_SetPostMix(
            MixFuncDelegate mix_func,
            IntPtr arg // void*
        );

        [DllImport(nativeLibName, EntryPoint = "Mix_HookMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_HookMusic(
            MixFuncDelegate mix_func,
            IntPtr arg // void*
        );

        [DllImport(nativeLibName, EntryPoint = "Mix_HookMusicFinished", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_HookMusicFinished(
            MusicFinishedDelegate music_finished
        );

        /* IntPtr refers to a void* */
        [DllImport(nativeLibName, EntryPoint = "Mix_GetMusicHookData", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr Mix_GetMusicHookData();

        [DllImport(nativeLibName, EntryPoint = "Mix_ChannelFinished", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_ChannelFinished(
            ChannelFinishedDelegate channel_finished
        );

        [DllImport(nativeLibName, EntryPoint = "Mix_RegisterEffect", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_UnregisterEffect", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_UnregisterEffect(
            int channel,
            Mix_EffectFunc_t f
        );

        [DllImport(nativeLibName, EntryPoint = "Mix_UnregisterAllEffects", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_UnregisterAllEffects(int channel);

        [DllImport(nativeLibName, EntryPoint = "Mix_SetPanning", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_SetPosition", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_SetDistance", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_SetDistance(int channel, byte distance);

        [DllImport(nativeLibName, EntryPoint = "Mix_SetReverseStereo", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_SetReverseStereo(int channel, int flip);

        [DllImport(nativeLibName, EntryPoint = "Mix_ReserveChannels", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_ReserveChannels(int num);

        [DllImport(nativeLibName, EntryPoint = "Mix_GroupChannel", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_GroupChannel(int which, int tag);

        [DllImport(nativeLibName, EntryPoint = "Mix_GroupChannels", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_GroupChannels(int from, int to, int tag);

        [DllImport(nativeLibName, EntryPoint = "Mix_GroupAvailable", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_GroupAvailable(int tag);

        [DllImport(nativeLibName, EntryPoint = "Mix_GroupCount", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_GroupCount(int tag);

        [DllImport(nativeLibName, EntryPoint = "Mix_GroupOldest", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_GroupOldest(int tag);

        [DllImport(nativeLibName, EntryPoint = "Mix_GroupNewer", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* chunk refers to a Mix_Chunk* */
        [DllImport(nativeLibName, EntryPoint = "Mix_PlayChannelTimed", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* music refers to a Mix_Music* */
        [DllImport(nativeLibName, EntryPoint = "Mix_PlayMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_PlayMusic(IntPtr music, int loops);

        /* music refers to a Mix_Music* */
        [DllImport(nativeLibName, EntryPoint = "Mix_FadeInMusic", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* music refers to a Mix_Music* */
        [DllImport(nativeLibName, EntryPoint = "Mix_FadeInMusicPos", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* chunk refers to a Mix_Chunk* */
        [DllImport(nativeLibName, EntryPoint = "Mix_FadeInChannelTimed", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_Volume", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_Volume(int channel, int volume);

        /* chunk refers to a Mix_Chunk* */
        [DllImport(nativeLibName, EntryPoint = "Mix_VolumeChunk", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_VolumeChunk(
            IntPtr chunk,
            int volume
        );

        [DllImport(nativeLibName, EntryPoint = "Mix_VolumeMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_VolumeMusic(int volume);

        [DllImport(nativeLibName, EntryPoint = "Mix_HaltChannel", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_HaltChannel(int channel);

        [DllImport(nativeLibName, EntryPoint = "Mix_HaltGroup", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_HaltGroup(int tag);

        [DllImport(nativeLibName, EntryPoint = "Mix_HaltMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_HaltMusic();

        [DllImport(nativeLibName, EntryPoint = "Mix_ExpireChannel", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_ExpireChannel(int channel, int ticks);

        [DllImport(nativeLibName, EntryPoint = "Mix_FadeOutChannel", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_FadeOutChannel(int which, int ms);

        [DllImport(nativeLibName, EntryPoint = "Mix_FadeOutGroup", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_FadeOutGroup(int tag, int ms);

        [DllImport(nativeLibName, EntryPoint = "Mix_FadeOutMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_FadeOutMusic(int ms);

        [DllImport(nativeLibName, EntryPoint = "Mix_FadingMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern Mix_Fading Mix_FadingMusic();

        [DllImport(nativeLibName, EntryPoint = "Mix_Fading Mix_FadingChannel", CallingConvention = CallingConvention.Cdecl)]
        public static extern Mix_Fading Mix_FadingChannel(int which);

        [DllImport(nativeLibName, EntryPoint = "Mix_Pause", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_Pause(int channel);

        [DllImport(nativeLibName, EntryPoint = "Mix_Resume", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_Resume(int channel);

        [DllImport(nativeLibName, EntryPoint = "Mix_Paused", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_Paused(int channel);

        [DllImport(nativeLibName, EntryPoint = "Mix_PauseMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_PauseMusic();

        [DllImport(nativeLibName, EntryPoint = "Mix_ResumeMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_ResumeMusic();

        [DllImport(nativeLibName, EntryPoint = "Mix_RewindMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Mix_RewindMusic();

        [DllImport(nativeLibName, EntryPoint = "Mix_PausedMusic", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_PausedMusic();

        [DllImport(nativeLibName, EntryPoint = "Mix_SetMusicPosition", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_SetMusicPosition(double position);

        [DllImport(nativeLibName, EntryPoint = "Mix_Playing", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_Playing(int channel);

        [DllImport(nativeLibName, EntryPoint = "Mix_PlayingMusic", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_SetSynchroValue", CallingConvention = CallingConvention.Cdecl)]
        public static extern int Mix_SetSynchroValue(int value);

        [DllImport(nativeLibName, EntryPoint = "Mix_GetSynchroValue", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(nativeLibName, EntryPoint = "Mix_EachSoundFont", CallingConvention = CallingConvention.Cdecl)]
        ...
        /* IntPtr refers to a Mix_Chunk* */
        [DllImport(nativeLibName, EntryPoint = "Mix_GetChunk", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr Mix_GetChunk(int channel);

        [DllImport(nativeLibName, EntryPoint = "Mix_CloseAudio", CallingConvention = CallingConvention.Cdecl)]
